...
export function makeDirs(p, done) {
  fs.mkdir(p, { recursive: true, mode: 0o755 }, done)
}

export function genSafeFilename(name) {
  let i = 0
...
export function genDeepPath(id, iter) {
  let path = ''
...
export function copyFile(src, tar, done) {
