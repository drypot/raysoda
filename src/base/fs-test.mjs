...
import * as fs2 from './fs.mjs'
import { pathExists, pathNotExists } from './assert.mjs'
...
describe('removeDir', () => {
  ...
  it('should work for one file', done => {
    fs2.removeDir(testPath('sub1/f1.txt'), err => {
  ...
  it('should work for one dir', done => {
    fs2.removeDir(testPath('sub1'), err => {
      expect(err).toBeFalsy()
      pathExists(testPath('sub2'))
      pathExists(testPath('sub2/sub3'))
      pathExists(testPath('sub2/f2.txt'))
  ...
  it('should work recursively', done => {
    fs2.removeDir(testPath('sub2'), err => {
      expect(err).toBeFalsy()
      pathExists(testPath('sub1'))
      pathExists(testPath('sub1/f1.txt'))
...
describe('makeDirs', () => {
  ...
  it('should succeed', done => {
    pathNotExists(testPath('sub1'))
    fs2.makeDirs(testPath('sub1'), function (err) {
      expect(err).toBeFalsy()
      pathExists(testPath('sub1'))
      pathNotExists(testPath('sub1/sub2/sub3'))
      fs2.makeDirs(testPath('sub1/sub2/sub3'), function (err) {
        expect(err).toBeFalsy()
...
describe('copyFile', () => {
  ...
  it('should succeed', done => {
    ...
    pathNotExists(t)
    fs2.copyFile('src/base/fs-test-dummy.txt', t, err => {
      expect(err).toBeFalsy()
      pathExists(t)
