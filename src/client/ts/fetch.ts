import { clearFormError, disableSubmitButton, enableSubmitButton, Form, reportFormError } from '@client/dom'
import { openErrorModal } from '@client/modal'

export function postData(url: string, form: Form, data: any, cb: (data: any) => void) {
