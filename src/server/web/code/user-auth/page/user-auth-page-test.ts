...
import { registerUserAuthPage } from './user-auth-page.js'
import { Config } from '../../../../_type/config.js'
import { DB } from '../../../../db/_db/db.js'
import { UserDB } from '../../../../db/user/user-db.js'
import { UserCache } from '../../../../db/user/cache/user-cache.js'
import { registerUserAuthApi } from '../api/user-auth-api.js'
import { insertUserFix4, USER1_LOGIN } from '../../../../db/user/fixture/user-fix.js'
import { NOT_AUTHENTICATED } from '../../../../_type/error-user.js'
import { loginForTest } from '../api/user-auth-api-fixture.js'
