...
export const USER1 = newUser({ id: 1, name: 'User 1', home: 'user1', email: 'user1@mail.test', hash: hash1, pdate: new Date(2019, 0, 10) })
export const USER2 = newUser({ id: 2, name: 'User 2', home: 'user2', email: 'user2@mail.test', hash: hash1, pdate: new Date(2019, 0, 20) })
export const USER3 = newUser({ id: 3, name: 'User 3', home: 'user3', email: 'user3@mail.test', hash: hash1, pdate: new Date(2019, 0, 15) })
export const ADMIN = newUser({ id: 4, name: 'Admin', home: 'admin', email: 'admin@mail.test', hash: hash1, pdate: new Date(2019, 0, 5), admin: true })
