...
import { type PageParam } from '../../common/type/page.js'
import { type ImagePage } from '../../common/type/image-list.js'
...
export class ImageDB {
  ...
  async updateImage(id: number, image: Partial<Image>) {
    const pack = newPack(image)
    const r = await this.db.update('update image set ? where id = ?', [pack, id])
