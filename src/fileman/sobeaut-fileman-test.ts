import { getSobeautFileManager } from './sobeaut-fileman.ts'
...
describe('SobeautFileManager', () => {
  ...
  describe('path', () => {
    it('root dir', () => {
      expect(ifm.dir).toBe('upload/sobeaut-test/public/images/')
      expect(ifm.url).toBe('http://file.sobeaut.test:8080/images/')
    })
    it('get dir', () => {
