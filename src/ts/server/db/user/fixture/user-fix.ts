...
export const USER1 = newUser({ id: 1, name: 'user1', home: 'user1', email: 'user1@mail.test', hash: hash1,
  cdate: new Date(2003, 0, 17), adate: new Date(2003, 0, 17), pdate: new Date(2019, 0, 10) })
export const USER2 = newUser({ id: 2, name: 'user2', home: 'user2', email: 'user2@mail.test', hash: hash1,
  cdate: new Date(2003, 1, 3), adate: new Date(2003, 1, 3), pdate: new Date(2019, 0, 20) })
export const USER3 = newUser({ id: 3, name: 'user3', home: 'user3', email: 'user3@mail.test', hash: hash1,
