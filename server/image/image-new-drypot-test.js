...
describe('getDir()', function () {
  it('should work for id 1', function () {
    ...
    expect(imageb.getPath(1)).equals(config.uploadDir + '/public/images/0/0/1.svg');
    expect(imageb.getDirUrl(1)).equals(config.uploadSite + '/images/0/0');
    expect(imageb.getThumbUrl(1)).equals(config.uploadSite + '/images/0/0/1.svg');
  });
  it('should work for id 1 234 567', function () {
    expect(imageb.getDir(1234567)).equals(config.uploadDir + '/public/images/1/234');
    expect(imageb.getPath(1234567)).equals(config.uploadDir + '/public/images/1/234/1234567.svg');
    expect(imageb.getDirUrl(1234567)).equals(config.uploadSite + '/images/1/234');
    expect(imageb.getThumbUrl(1234567)).equals(config.uploadSite + '/images/1/234/1234567.svg');
  });
});
